...
interface DecrementFollowersCountReturnValue {
    queryResult: FindUserDetailsQueryType
}

export function decrementFollowersCount(options: DecrementFollowersCountOptions): DecrementFollowersCountReturnValue {
